...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FakeBody', function() {
      beforeEach(function() {
        instance = new SwaggerPetstore.FakeBody();
      });

      it('should create an instance of FakeBody', function() {
        // TODO: update the code to test FakeBody
        expect(instance).to.be.a(SwaggerPetstore.FakeBody);
      });
